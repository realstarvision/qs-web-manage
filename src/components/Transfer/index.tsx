...
function notNew(a: readonly number[], b: number) {
...
export default function TransferList() {
  ...
  const handleToggle = (value: number, type: string) => () => {
    ...
    if (type === 'left') {
      ...
      setLeft(notNew(left, value))
      // setChecked([])
      // setChecked(not(checked, leftChecked))
    } else {
      setRight(notNew(right, value))
      setLeft([...left, value])
      // setChecked([])
    }
  ...
  const customList = (items: readonly number[], type: string) => (
...
function type(value: number, type: any): React.MouseEventHandler<HTMLDivElement> | undefined {
