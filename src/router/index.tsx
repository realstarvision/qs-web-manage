...
import WorkOrder from '@/pages/order-management'
...
const router = [
  ...
  },
  {
    ...
    element: lazyload(
      <Layout>
        <DepartRolePrivileges></DepartRolePrivileges>
      </Layout>
    ),
  },
  {
    ...
    element: lazyload(
      <Layout>
        <AddAccountManage></AddAccountManage>
      </Layout>
    ),
  },
  {
    ...
    element: lazyload(
      <Layout>
        <EditAccountManage></EditAccountManage>
      </Layout>
    ),
  },
  {
    ...
    element: lazyload(
      <Layout>
        <WatchAccountManage></WatchAccountManage>
      </Layout>
    ),
  },
  {
    path: '/instrument-panel/workOrder/add',
    name: '工单新增',
    element: lazyload(
      <Layout>
