      ...
      <Paper>
        <Box className="noticeKinds-container">
          ...
          <Box className="noticeKindsAddBox">
            <Button
              className="noticeKindsAddBut"
              onClick={() => {
                navigate('/instrument-panel/early-warning/noticeKinds/addNoticeKinds')
              }}
            >
              + &nbsp; 新增公告
            </Button>
          ...
          <Box className="noticeKindsPage">
            <Box className="noticeKindsDelBox">
              ...
              >
                {' '}
                <Button disabled={selectedRowKeys.length === 0 ? true : false} className="noticeKindsDelBut">
                  删除
                </Button>
              </Popconfirm>
            </Box>
