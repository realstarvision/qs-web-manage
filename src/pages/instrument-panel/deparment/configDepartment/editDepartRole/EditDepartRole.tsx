...
export default function EditDepartRole() {
  ...
  // 右侧角色总数状态
  const [editDepartRoleAllNum, setEditDepartRoleAllNum] = useState<
    Number | '' | ReactI18NextChild | Iterable<ReactI18NextChild>
  >(5)
  // 角色描述输入框改变事件
  ...
  return (
    ...
    <div className="EditDepartRole">
      {/* 面包屑 */}
      <div className="EditDepartRoleBra">
        {' '}
      ...
      <div className="EditDepartRoleMain">
        <Grid container className="EditDepartRoleContainer">
            ...
            <div>
              ...
              <div className="EditDepartRoleForm">
                ...
                <Grid container style={{ background: '#fff' }} xs={12} rowSpacing={2}>
                  ...
                  <Grid item xs={12} className="EditDepartRoleName">
                  ...
                  <Grid item xs={12}>
                    <Link
                      to={'/instrument-panel/department/configDepartment/departRolePrivileges'}
                      className="DepRoleEditToPri"
                    >
                      修改权限配置
                    </Link>
                  </Grid>
          ...
          <Grid className="EditDepRolContainer" item xs={0.4}>
            <Divider type="vertical" className="EditDepRolContainerDivider"></Divider>
          </Grid>
          ...
          <Grid className="EditDepartRoleRight" item xs={6.5}>
            <div className="EditDepartRoleRightTitle">
              <div className="EditDepartRoleRightTitleLeft">
                <span>当前角色人数：</span>
                <span className="EditDepartRoleAllNum">{editDepartRoleAllNum}</span>
              </div>
              {/* <div>
                <Button 
            ...
            <div>
              <EditDepartRoleTable></EditDepartRoleTable>
            </div>
          </Grid>
        </Grid>
      </div>
